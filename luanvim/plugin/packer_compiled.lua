...
_G.packer_plugins = {
  ...
  ReplaceWithRegister = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/ReplaceWithRegister",
  ...
  ["mason-null-ls.nvim"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/mason-null-ls.nvim",
  ...
  ["nvim-ts-autotag"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/chris/.local/share/nvim/site/pack/packer/opt/nvim-ts-autotag",
  ...
  ["vim-maximizer"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/vim-maximizer",
    url = "https://github.com/szw/vim-maximizer"
  },
  ["vim-nightfly-guicolors"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/vim-nightfly-guicolors",
  ...
  ["wildfire.vim"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/wildfire.vim",
